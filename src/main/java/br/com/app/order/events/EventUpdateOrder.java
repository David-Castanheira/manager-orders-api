...
public class EventUpdateOrder {
    ...
    public EventUpdateOrder(Integer orderId, String name, LocalDateTime order_date, BigDecimal total_value, String status, LocalDateTime timestamp) {
